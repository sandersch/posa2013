...
Please design this program in Scala 2.10 or above without using frameworks or libraries other than the JDK and Scala standard libraries and contain code in a single file. Someone should be able to run something like `scalac Program.scala` and `scala Program` and your program should successfully run!

You can find some Scala resources at:
